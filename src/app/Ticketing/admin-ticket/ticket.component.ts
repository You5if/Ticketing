...
creationSort(sortString: string) {
  ...
  openEntry = function (result: TicketModel) {
    if (result === undefined) {
      this.dialogRef = this.dialog.open(AdminTicketEntryComponent, {
        disableClose: true,
        data: {}
      });
    } else {
  ...
  openDetails = function (result: any) {
    if (result === undefined) {
      this.dialogRef5 = this.dialog5.open(AdminDetailsEntryComponent, {
        disableClose: true,
  ...
  openEntry3 = function (result: Send, ticket: TicketModel) {
    if (result === undefined) {
      this.dialogRef1 = this.dialog1.open(AdminTicketCloseEntryComponent, {
        disableClose: true,
  ...
  openEntry4 = function (result: Send, ticket: TicketModel) {
    if (result === undefined) {
      this.dialogRef1 = this.dialog1.open(AdminTicketVerifyEntryComponent, {
        disableClose: true,
  ...
  openCommentDialog = function(result: TicketModel) {
    if (result === undefined) {
      this.dialogRef2 = this.dialog2.open(AdminAddCommentComponent, {
        disableClose: true,
  ...
  openAssignedDialog = function(result: TicketModel) {
    if (result === undefined) {
      this.dialogRef3 = this.dialog3.open(AdminAssignedComponent, {
        disableClose: true,
  ...
  openTransferDialog = function(result: TicketModel) {
    if (result === undefined) {
      this.dialogRef4 = this.dialog4.open(AdminTransferComponent, {
        disableClose: true,
